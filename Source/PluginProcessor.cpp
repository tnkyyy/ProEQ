...
bool ProEQAudioProcessor::acceptsMidi() const
{
...
bool ProEQAudioProcessor::producesMidi() const
{
...
bool ProEQAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double ProEQAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int ProEQAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int ProEQAudioProcessor::getCurrentProgram()
{
    return 0;
}
...
const juce::String ProEQAudioProcessor::getProgramName (int index)
{
    return {};
}

void ProEQAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void ProEQAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
//==============================================================================
bool ProEQAudioProcessor::hasEditor() const
{
